            ...
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-2">
                  ...
                  <div class="badge" :class="getResultBadgeClass(record.result)">{{ record.result }}</div>
            ...
            <div v-if="expandedRecord === record.id" class="mt-4 pt-4 border-t border-base-300">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div class="space-y-1">
                    <div v-for="feature in record.features" :key="feature.name" class="flex justify-between">
                ...
                <div>
                  ...
                  <p class="text-sm text-base-content/70 bg-base-100 p-3 rounded">{{ record.content }}</p>
                </div>
              </div>
            </div>
          </div>
